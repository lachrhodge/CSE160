...
class Vector3 {
    ...
    add(other) {
        ...
        for(var i = 0; i < 3; i++){
            this.elements[i] = Number(this.elements[i]) + Number(other.elements[i]);
        }
    ...
    div(scalar) {
        ...
        // This function should change this vector (this.elements) and not create a new vector.
        for(var i = 0; i < 3; i++){
            this.elements[i] = Number(this.elements[i]) / scalar;
        }
        // Don't delete the return statement.
        return this;
    };
    ...
    magnitude() {
        ...
        // pythagorian theorem m^2=x^2+y^2+z^2
        for(var i = 0; i < 3; i++){
            m += Number(this.elements[i]) ** 2;
        }
        m = Math.sqrt(m);
        // Don't delete the return statement.
        return m;
    ...
    normalize() {
        ...
        console.log(m);
        for(var i = 0; i < 3; i++){
            this.elements[i] = Number(this.elements[i]) / m;
        }
